var NemoCV = {
	...
	drawExperienceTimeLine: function() {
		...
		var e = new Raphael("experienceTimeLine", 900, 680),
			t = [
				[200, 25, "#97BE0D", "2005.09 - 2009.06，成都", "通信工程专业 本科 (电子科技大学)", ""],
				/*
				[300, 20, "#88B8E6", "2009.07 - 2010.06", "南校B7计算机中心", "嵌入式软件工程师", ],
				*/
				[400, 10, "#88B8E6", "2010.07 - 2011.06", "广州赛麟信息技术有限公司", "兼职网站开发，负责公司网站建设和维护"],
				[500, 10, "#88B8E6", "2011.07 - 2013.02", "广州一刻影像科技有限公司", "Web前台开发，负责一刻网（ikefoto.com）维护和重构、改版工作"],
				[600, 20, "#989898", "2013.07 - 至今", "百度", ""]
			],
			n = [
				["#97BE0D", 400, "学习"],
				["#88B8E6", 530, "工作经历"]
...
$(function() {
	...
	o[0] = function() {
		$.browser.msie && $("#" + e[0] + " h2").animate({
			opacity: 1
		}, 2e3), NemoCV.drawIcons(), $(".leftBracket").animate({
			left: "-50",
			opacity: 1
